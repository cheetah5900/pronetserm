...
<div style="background-color: #e1f0ff;" class="divcontent">
    <center><img class="imgsim" src="../pronetimg/True/newsim/heartsim/1.png"></center><br>
       <h2> เน็ตไม่อั้น ไม่ลดสปีด</h2>
    <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ซิมโดนใจ ทุกโปรแถม<font class="redtextforsale textforsale"> โทรฟรีทุกเครือข่าย </font>มีความเร็วที่ 
    <font class="orangetextforsale textforsale">2 Mbps</font> หรือ <font class="pinktextforsale textforsale">4 Mbps </font>หรือ 
    <font class="yellowtextforsale textforsale">10 Mbps </font> รองรับความเร็วระดับ 5G* และสัญญาณครอบคลุมทั่วประเทศทำให้มั่นใจได้ว่า 
    สามารถใช้งานได้ทุกพื้นที่ที่ความเร็วสูงสุดของโปรโมชั่นแน่นอน</p><font class="graytextforsale textforsale">* โทรศัพท์จะต้องรองรับ 5G ด้วย</font>
</div>

<div style="background-color: #ffebd7;">
    <div align="left" class="divcontent"><h2> <font color="#EC2554">ใช้ได้นาน </font><font class="biggerfont" color="#ba0a34">30</font> <font color="#EC2554">วัน</font></h2></div>
    <div align="center" class="divcontent"><h2> <font color="#a51e52">ต่ออายุได้อีก </font><font class="biggerfont" color="#890639">5</font> <font color="#a51e52">รอบ</font></h2></div>
    <div align="right" class="divcontent"><h2> <font color="#9c348a">ใช้งานได้ยาว </font><font class="biggerfont" color="#80106d">180</font> <font color="#9c348a">วัน</font></h2></div>
    ...
    <div align="right"><img class="imgsim" src="../pronetimg/True/newsim/heartsim/2.png"></div>
</div>

<div style="background-color: #FFFCD4;">
    <div align="center" class="divcontent"><br><h2> <font color="#c1b101" class="biggerfont">เติมเงินให้พอ <br>แล้วสมัครโปรที่ใช่<br> </font>(มีโทรฟรีทุกโปรนะ)</h2></div>
    <div class="row" style="margin: 0;">
        <div class="col-md-6" style="float:none;margin:auto;">
            <img class="imgsalepage" src="../pronetimg/True/newsim/heartsim/5.png">
        </div>
        <div class="col-md-6"style="">
            <div><img class="imgsalepage" src="../pronetimg/True/newsim/heartsim/3.png"></div>
        </div>
    </div>
</div>
...
<div style="background-color: #FFDFD5;">
    ...
    <div align="right"><img class="imgsim" src="../pronetimg/True/newsim/heartsim/4.png"></div>
</div>
...
<div style="background-color: #ffe5d9;" class="divcontent">
       <center><h2><font color="#EC2554">ซิมราคา </font><font class="biggerfont" color="#ba0a34">69</font> <font color="#EC2554">บาท</font></h2>
    <p><font class="biggerfont" color="red">ส่งฟรี !</font><br><br>เก็บเงินปลายทางสำหรับคนที่กดสั่งซื้อกับปุ่มด้านล่างเท่านั้น</p></center>
</div>
